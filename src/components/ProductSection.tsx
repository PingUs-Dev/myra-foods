            ...
            >
              ...
              <div className="p-6 space-y-4">
                ...
                <div className="flex items-center justify-between pt-4">
                  ...
                  <button className="bg-yellow-400 hover:bg-yellow-500 text-gray-800 px-6 py-2 rounded-xl font-medium transition-all duration-200 transform hover:scale-105">
                    Add to Cart
                  </button>
                </div>
              </div>
